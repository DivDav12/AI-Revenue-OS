...
class EcosystemViewTests(unittest.TestCase):
    ...
    def test_panel_renders_svg_creatures(self):
        ...
        self.assertEqual(html.count("class='eco "), 30)   # 30 little creatures
    ...
    def test_creatures_carry_avatar_glyph_and_home_coords(self):
        ...
        self.assertEqual(html.count("data-hx="), 30)
        self.assertEqual(html.count("class=eco-icon"), 30)
