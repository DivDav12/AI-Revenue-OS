...
AGENTS: tuple[AgentSpec, ...] = (
    ...
    AgentSpec("opportunity_finder", "Opportunity Finder", "discovery", "Scoring",
              "evaluate", node="evaluator", mode_field="evaluator",
              on_value="llm", off_value="keyword", spend_activity="evaluate",
              status="live"),
    ...
    AgentSpec("trend_hunter", "Trend Hunter", "discovery", "Emerging demand",
              "discover_trends", node="discovery"),
